...
export function Footer() {
  return (
    <footer className="bg-background-alt border-t border-border mt-24">
      <div className="container-app py-14 grid gap-10 md:grid-cols-[2fr_1fr_1fr_1fr_1.5fr]">
        <div>
          <Logo />
        ...
        <div>
          <h4 className="text-sm font-semibold text-maroon mb-3">Location</h4>
          <div className="rounded-lg overflow-hidden border border-border h-32 w-full bg-surface">
            <iframe
